...
const CATEGORIES = ["All", "2 Seaters", "3 Seaters", "Bar Units", "Book Shelves", "Buffets", "Chest Boxs", "Chest of Drawss", "Diwans", "Misc", "Outdoor", "Puja Units", "Shoe Racks", "Showcases", "Sofas", "Wardrobes"];
